...
class nnUNetTrainer(object):
    ...
    def on_train_start(self):
        ...
        tmp_batch_size = self.plans_manager.plans["configurations"]['3d_fullres']['batch_size']
        model_summary_file = open(join(self.output_folder_base, f'fold_{self.fold}/model_summary.txt'),'w')
        model_summary_file.write(str(summary(self.network, inputsize = self.plans_manager.plans["configurations"]['3d_fullres']['patch_size'].insert(0,tmp_batch_size))))
        model_summary_file.close()
        print(f"finish writing the model summary file")
